    ...
    public static void handleWelcomeScreenInput() {
        ...
        do {
            try {
                ...
                switch (input) {
                    case 1:
                        filroPeration.displayAllFiles("main");
                        break;
                    case 2:
    ...
    public static void handleFileMenuOptions() {
        ...
        do {
            try {
                ...
                filroPeration.createMainFolderIfNotPresent("main");
                ...
                switch (input) {
                    case 1:
                        ...
                        filroPeration.createFile(fileToAdd, sc);
                    ...
                    case 2:
                        ...
                        filroPeration.createMainFolderIfNotPresent("main");
                        List<String> filesToDelete = filroPeration.displayFileLocations(fileToDelete, "main");
                        ...
                        if (idx==0) {
                            for (String path : filesToDelete) {
                                filroPeration.deleteFileRecursively(path);
                            }
                        }
                        else {
                    ...
                    case 3:
                        ...
                        filroPeration.createMainFolderIfNotPresent("main");
                        filroPeration.displayFileLocations(fileName, "main");
                        break;
                    case 4:
                        // Go to Previous menu
                        return;
